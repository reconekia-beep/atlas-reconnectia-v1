...
function testDim() {
    return __awaiter(this, void 0, void 0, function () {
        var apiKey, url, res, _a, _b, _c, data;
        var _d, _e;
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    data = _f.sent();
                    console.log("Values length:", (_e = (_d = data === null || data === void 0 ? void 0 : data.embedding) === null || _d === void 0 ? void 0 : _d.values) === null || _e === void 0 ? void 0 : _e.length);
                    return [2 /*return*/];
            }
        });
    });
